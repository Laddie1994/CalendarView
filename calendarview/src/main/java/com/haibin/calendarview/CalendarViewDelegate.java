...
//        }
    ...
    void setTextColor(int curDayTextColor, int curMonthTextColor, int otherMonthTextColor, int curMonthLunarTextColor
            , int otherMonthLunarTextColor, int curDayLunarTextColor) {
        ...
        mCurDayLunarTextColor = curDayLunarTextColor;
    }
    ...
    void setYearViewTextColor(int yearViewMonthTextColor, int yearViewDayTextColor, int yarViewSchemeTextColor
            , int yearViewWeekTextColor, int yearViewCurDayTextColor, int yearViewSelectTextColor) {
        ...
        this.mYearViewWeekTextColor = yearViewWeekTextColor;
        this.mYearViewCurDayTextColor = yearViewCurDayTextColor;
        this.mYearViewSelectTextColor = yearViewSelectTextColor;
    }
